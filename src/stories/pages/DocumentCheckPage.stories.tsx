...
const mockDocuments: fetchedDocument[] = [
  { uuid: '1', subject: 'Subject 1', url: 'https://example.com/1', source: 'Source 1', page: 1 },
  { uuid: '2', subject: 'Subject 2', url: 'https://example.com/2', source: 'Source 2', page: 2 },
  { uuid: '3', subject: 'Subject 3', url: 'https://example.com/3', source: 'Source 3', page: 3 },
];
...
export const WithOneDocument: Story = {
  args: {
    documents: [{ uuid: '1', subject: 'Single Document', url: 'https://example.com/1', source: 'Single Source', page: 1 }],
  },
};
